...
# INFERIR estoque inicial de cada mídia (maior valor de EstoqueRestante no início de maio)
...
# ==== Adiciona linha(s) de estoque final ====
...
# Salva os dois DataFrames em abas separadas dentro do mesmo arquivo Excel
...
print(f"Arquivo Excel '{arquivo_excel}' gerado com abas 'Original' e 'Simulacao_Junho_Dobro', incluindo estoque final.")